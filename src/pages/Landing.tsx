    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      <header className="border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            <ThemeToggle />
            <LanguageToggle />
            <Link to="/login" className="text-sm font-medium text-neutral-700 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-neutral-100">
              {t('landing.ctaLogin')}
            </Link>
            <Link to="/signup">
      ...
      <main>
        <section className="mx-auto max-w-4xl px-4 py-16 text-center sm:py-24">
          <h1 className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-5xl dark:text-neutral-100">{t('landing.heroTitle')}</h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-neutral-600 dark:text-neutral-400">{t('landing.heroSubtitle')}</p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
              {FEATURES.map((f) => (
                <div key={f} className="text-center">
                  <h3 className="mb-2 text-lg font-semibold text-neutral-900 dark:text-neutral-100">{t(`landing.${f}Title`)}</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400">{t(`landing.${f}Desc`)}</p>
                </div>
              ))}
            </div>
          </div>
