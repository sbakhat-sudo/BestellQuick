          ...
          <li key={step} className="flex gap-3">
            <div className="flex flex-col items-center">
              <span
                className={clsx(
                  ...
                  done ? 'bg-brand-600 text-white' : 'bg-neutral-200 text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400',
                )}
              >
                {i + 1}
              </span>
              {!isLast && (
                <span
                  className={clsx('w-0.5 flex-1', done ? 'bg-brand-600' : 'bg-neutral-200 dark:bg-neutral-800')}
                  style={{ minHeight: 24 }}
                />
              )}
            </div>
            <p
              className={clsx(
                ...
                done ? 'text-neutral-900 dark:text-neutral-100' : 'text-neutral-400 dark:text-neutral-600',
              )}
            >
